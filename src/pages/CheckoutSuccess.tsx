              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-col space-y-4 pt-4 sm:flex-row sm:space-x-4 sm:space-y-0">
                  <Button
                    ...
                    onClick={() => {
                      if (purchaseData?.isMock) {
                        // For mock downloads, show a message instead of navigating to a non-existent URL
                        toast.info("This is a test purchase. In production, you would download the actual eBook.");
                      } else {
                  ...
                  >
                    ...
                    {purchaseData?.isMock ? "Test Download" : "Download eBook"}
                  </Button>
                  <Button
                    variant="outline"
