DO $$
BEGIN
  -- Check if the blog post with slug 'benefits-of-chamomile-tea' exists
  IF NOT EXISTS (SELECT 1 FROM public.blog_posts WHERE slug = 'benefits-of-chamomile-tea') THEN
...
Enjoy the soothing benefits of this wonderful herbal tea!',
  ...
  -- Check if the blog post with slug 'essential-herbs-home-garden' exists
  IF NOT EXISTS (SELECT 1 FROM public.blog_posts WHERE slug = 'essential-herbs-home-garden') THEN
...
Start with these five herbs, and you''ll have a wonderful foundation for your home herb garden!',
  ...
  -- Check if the blog post with slug 'adaptogens-ancient-herbs-modern-stress' exists
  IF NOT EXISTS (SELECT 1 FROM public.blog_posts WHERE slug = 'adaptogens-ancient-herbs-modern-stress') THEN
    -- Insert the third blog post
    INSERT INTO public.blog_posts (
      title,
      slug,
      content,
